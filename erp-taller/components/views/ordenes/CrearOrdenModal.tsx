      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6">
        ...
        <div>
          <div className="flex justify-between items-center mb-4">
            <h3 className="font-headline font-semibold text-secondary dark:text-neutral-light">Líneas de Detalle</h3>
          ...
          <div className="space-y-3">
            {detalles.map((det, index) => (
              <div key={index} className="flex flex-col md:flex-row gap-3 items-end bg-neutral-light/50 dark:bg-black/10 p-4 rounded-2xl border border-white/20 dark:border-white/5">
        ...
        {/* Totales y Submit */}
        <div className="bg-white/80 dark:bg-secondary/80 backdrop-blur-xl p-4 rounded-2xl border border-primary/20 flex flex-col md:flex-row justify-between items-center gap-4 mt-2">
